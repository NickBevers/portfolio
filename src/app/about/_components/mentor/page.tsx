    ...
    <div className={styles.mentor__container}>
      <div className={styles.mentor__content}>
        ...
        <div className={styles.mentor__textContent}>
          ...
          <p className={styles.mentor__description}>When I get the opportunity, I never pass up on having the pleasure of sharing my knowledge with others. Being able to help someone is something I thoroughly enjoy and I hope to continue that. A team grows faster with the support and knowledge of everyone involved after all.</p>
        </div>
      </div>
    </div>
  );
