            ...
            <div className={styles.about__intro}>
                <div className={styles.about__introContent}>
                    <h1 className={styles.about__title}>
                        Hey there, my <br />
                        name is <span style={{color: 'var(--blue--secondary)'}}>Nick</span>, developer, <span className={styles.superScript}>(1)</span><br />
                        teacher <span className={styles.superScript}>(2)</span> and experimenter <span className={styles.superScript}>(3)</span>.
                    </h1>
